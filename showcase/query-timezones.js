function queryTimezones () {
	return new Promise((resolve, reject) => {
		resolve([{'capital': 'Andorra la Vella',
			'code': 'AD',
			'continent': 'Europe',
			...
			{'capital': 'SÃ£o TomÃ©',
				'code': 'ST',
				'continent': 'Africa',
				'country_name': 'SÃ£o TomÃ© and PrÃ\xadncipe',
				'name': 'SÃ£o TomÃ© and PrÃ\xadncipe, Sao_Tome',
